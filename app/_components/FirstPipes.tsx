...
const FirstPipes = () => {
    ...
    return (
        <div className="relative flex items-center gap-2 w-fit h-[25px] mx-auto lg:mt-10 lg:mb-20 lg:scale-100 md:scale-75 scale-[.65]">
            <div className="absolute top-0 -left-2 flex flex-col gap-2 -translate-x-full">
                <img alt="line" src='line-4.png' className={`${activeIndex === 9 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-fit h-fit  transition-all duration-500`} />
                <img alt="line" src='line-2.png' className={`${activeIndex === 10 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-[25px] h-[100px] transition-all duration-500`} />
                <img alt="circle" src='circle-1.png' className={`${activeIndex === 11 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-fit h-fit transition-all duration-500`} />
            </div>
            ...
            <img alt="line" src="line-1.png" className={`${activeIndex === 3 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-[100px] h-[25px] transition-all duration-500`} />
