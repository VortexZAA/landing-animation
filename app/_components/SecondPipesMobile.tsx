...
const SecondPipesMobile = () => {
    ...
    return (
        <div className="relative flex items-center gap-2 w-fit h-[25px] mx-auto scale-[.65]">
            ...
            <img alt="line" src="line-1.png" className={`${activeIndex === 4 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-[33vw] h-[25px] transition-all duration-500`} />
            <img alt="line" src="line-1.png" className={`${activeIndex === 5 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-[33vw] h-[25px] transition-all duration-500`} />
            <img alt="line" src="line-1.png" className={`${activeIndex === 6 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-[33vw] h-[25px] transition-all duration-500`} />
            <div className="absolute top-0 -right-2 flex flex-col items-end gap-2 translate-x-full">
                <img alt="line" src='line-6.png' className={`${activeIndex === 7 ? 'opacity-100' : 'opacity-50'} bg-opacity-60 w-fit h-fit transition-all duration-500`} />
...
export default SecondPipesMobile