          ...
          <div className="items-center justify-center w-full grid md:grid-cols-2 lg:grid-cols-3 h-full lg:h-2/3 gap-3 md:gap-4 xl:gap-6">
            <div className="backdrop-blur-sm bg-cardBg border-cardBorder border-[3px] rounded-xl shadow-md w-full gap-10 h-full p-6 flex flex-col justify-between">
              <Image
                ...
                height={500}
                quality={100}
                className=" absolute h-1/2 w-fit -top-8 -left-6"
                alt=""
              />
              <Image
                ...
                height={500}
                quality={100}
                className=" absolute h-1/2 w-fit -bottom-8 -right-6"
                alt=""
              />
              <Vip text="Seed 1" />
            ...
            <div className="backdrop-blur-sm bg-cardBg border-cardBorder border-[3px] rounded-xl shadow-md w-full gap-6 h-full p-6 flex flex-col justify-between">
              <Image
                ...
                width={500}
                height={500}
                className=" absolute h-fit w-full -top-8 -left-0"
                alt=""
              />
              <Image
                src={"/assets/cards/3.1.png"}
                width={500}
                height={500}
                className=" absolute h-fit w-full -bottom-[15%] -left-0"
                alt=""
              />
              <Vip text="Seed 2" />
            ...
            <div className="backdrop-blur-sm bg-cardBg border-cardBorder border-[3px] rounded-xl shadow-md w-full gap-6 h-full p-6 flex flex-col justify-between">
              <Image
                ...
                width={500}
                height={500}
                className=" absolute h-full w-fit -right-6 -top-6"
                alt=""
              />
              <Vip text="Seed 3" />
