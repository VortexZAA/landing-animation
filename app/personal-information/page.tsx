  ...
  return (
    <Layout title="Personel Information">
      <div className="grid grid-cols-2 xl:grid-cols-5 gap-3 md:gap-5 text-white">
        <div className="col-span-2 xl:col-span-full p-3 md:p-4 2xl:p-6 justify-between items-center bg-cardBg border-cardBorder border-[3px] rounded-md shadow-md w-ful flex flex-col gap-3">
          <div className="flex justify-between w-full">
            ...
            <div className="shrink-0 w-fit flex">
              <Vip
                text={
                  vipLvl === 3 ? "VIP 3" : vipLvl === 2 ? "VIP 2" : "VIP 1"
                }
              />
            </div>
          </div>
        ...
        <form
          ...
          className={` ${
            islisting && ""
          }  col-span-2 p-3 md:p-4 2xl:p-6 hidden  flex-col justify-center items-start gap-3 text-black bg-cardBg border-cardBorder border-[3px] rounded-md shadow-md relative`}
        >
          {islisting && (
        ...
        <div
          className={` col-span-2 xl:col-span-3 p-3 md:p-4 2xl:p-6 justify-start items-start bg-cardBg border-cardBorder border-[3px] rounded-md shadow-md w-full flex flex-col gap-3 relative`}
        >
          {islisting && (
            <div className="absolute left-0 top-0 rounded-sm w-full h-full bg-white/10 backdrop-blur-sm cursor-not-allowed z-10 flex  " />
          )}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center w-full gap-3 md:gap-6 pt-8 md:pt-6">
            ...
            <button
              ...
              disabled={loading || islisting}
              className="border-2 border-purple disabled:bg-cardBg  disabled:text-black disabled:cursor-not-allowed hover:bg-purple w-full md:w-fit hover:text-white transition-colors rounded-md py-3 px-3 md:px-4 2xl:px-6 shrink-0"
            >
              Upgrade your wallet
            </button>
        ...
        <div className="flex flex-col col-span-2 p-3 md:p-4 2xl:p-6 gap-3 bg-cardBg border-cardBorder border-[3px] rounded-md shadow-md w-ful">
