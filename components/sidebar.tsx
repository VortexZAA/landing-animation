...
export default function SideBar() {
    ...
    },
    {
      ...
      icon: (
        <svg width='16' height='20' viewBox='0 0 16 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path fillRule='evenodd' clipRule='evenodd' d='M5 12C2.23858 12 0 14.2386 0 17C0 18.6569 1.34315 20 3 20H13C14.6569 20 16 18.6569 16 17C16 14.2386 13.7614 12 11 12H5Z' fill='currentColor' />
          <path fillRule='evenodd' clipRule='evenodd' d='M8 0C5.23858 0 3 2.23858 3 5C3 7.76142 5.23858 10 8 10C10.7614 10 13 7.76142 13 5C13 2.23858 10.7614 0 8 0Z' fill='currentColor' />
        </svg>
      ),
      status: !isEmty,
    },
    /* {
      ...
      icon: (
        <svg width='20' height='20' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
            d='M14.6418 9.6269L8.79629 2.9198C8.59494 2.68805 8.29419 2.55518 7.97019 2.55518C7.64543 2.55518 7.34392 2.68805 7.14334 2.91929L1.29708 9.6269C1.24367 9.68823 1.19615 9.7567 1.166 9.81471C0.882371 10.2524 0.970525 10.8654 1.36683 11.2106L1.57406 11.3902C1.79099 11.5788 2.06517 11.6825 2.34649 11.6825C2.66103 11.6825 2.95616 11.5507 3.15623 11.3207L6.71126 7.24113V22.1304C6.71126 22.7488 7.21463 23.2519 7.83298 23.2519L8.1069 23.2522H8.10715C8.72525 23.2522 9.22837 22.749 9.22837 22.1307V7.24164L12.7834 11.3202C12.9832 11.5502 13.2786 11.6823 13.5934 11.6823C13.8755 11.6823 14.1504 11.5783 14.3676 11.3892L14.5738 11.2101C14.8076 11.0059 14.9361 10.7198 14.9359 10.405C14.9356 10.1247 14.8288 9.84128 14.6418 9.6269Z'
            fill='currentColor'
          />
          <path
            d='M18.4801 2.96838L16.0264 0.153052C15.9419 0.0557724 15.8157 0 15.6797 0C15.5433 0 15.4168 0.0557724 15.3326 0.152838L12.8786 2.96838C12.8562 2.99412 12.8362 3.02286 12.8236 3.04721C12.7045 3.23094 12.7415 3.48824 12.9079 3.63314L12.9949 3.70854C13.0859 3.7877 13.201 3.83124 13.3191 3.83124C13.4511 3.83124 13.575 3.7759 13.659 3.67937L15.1512 1.96694V8.21678C15.1512 8.47633 15.3625 8.68752 15.6221 8.68752L15.737 8.68762H15.7372C15.9966 8.68762 16.2078 8.47644 16.2078 8.21688V1.96716L17.7 3.67916C17.7839 3.77568 17.9079 3.83114 18.04 3.83114C18.1584 3.83114 18.2738 3.78748 18.365 3.70811L18.4516 3.63293C18.5497 3.54723 18.6036 3.42711 18.6035 3.29497C18.6034 3.17731 18.5586 3.05837 18.4801 2.96838Z'
            fill='currentColor'
          />
          <path
            d='M23.8114 12.2054L20.0587 7.89961C19.9295 7.75083 19.7364 7.66553 19.5284 7.66553C19.3199 7.66553 19.1263 7.75083 18.9976 7.89928L15.2444 12.2054C15.2101 12.2448 15.1796 12.2887 15.1603 12.326C14.9782 12.607 15.0348 13.0005 15.2892 13.2221L15.4222 13.3374C15.5615 13.4585 15.7375 13.5251 15.9181 13.5251C16.1201 13.5251 16.3095 13.4404 16.438 13.2928L18.7202 10.6738V20.2324C18.7202 20.6293 19.0433 20.9523 19.4403 20.9523L19.6162 20.9525H19.6163C20.0131 20.9525 20.3361 20.6295 20.3361 20.2325V10.6741L22.6184 13.2925C22.7466 13.4401 22.9363 13.5249 23.1384 13.5249C23.3195 13.5249 23.496 13.4581 23.6354 13.3368L23.7678 13.2218C23.9179 13.0907 24.0004 12.907 24.0002 12.7049C24 12.5249 23.9315 12.343 23.8114 12.2054Z'
            fill='currentColor'
          />
        </svg>
      ),
    ...
    }, */
    {
      ...
      icon: (
        <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path fillRule='evenodd' clipRule='evenodd' d='M6.45925 6C4.02505 6 2.1552 8.15595 2.49945 10.5657L3.51965 17.7071C3.87155 20.1704 5.98115 22 8.4694 22H15.531C18.0193 22 20.1289 20.1704 20.4808 17.7071L21.501 10.5657C21.8452 8.15595 19.9754 6 17.5412 6H6.45925Z' fill='currentColor' />
          <path
            fillRule='evenodd'
            clipRule='evenodd'
  ...
  return (
    <>
      <nav className=" flex flex-col w-fit xl:w-64 shrink-0 border-solid h-screen top-0  justify-between items-center text-white px-3 md:px-4 pb-12 pt-24 transition-  text-sm fixed z-50">
        <ul className="w-full">
          {menu.map(
            (item) =>
              item.status && (
