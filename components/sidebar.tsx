...
export default function SideBar() {
  ...
  return (
    <>
      <nav className=" flex flex-col w-fit xl:w-64 shrink-0 border-solid h-screen top-0  justify-between items-center text-white px-3 md:px-4 pb-6 md:pb-10 pt-3 md:pt-6 gap-6 transition-  text-sm fixed z-50">
