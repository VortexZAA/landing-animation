...
function initFramebuffers() {
  try {
    ...
    console.log(error);
    if (error.message.includes("GL_INVALID_FRAMEBUFFER_OPERATION")) {
      // GL_INVALID_FRAMEBUFFER_OPERATION hatası alındığında
      // Sayfayı yenileme kodunu buraya ekleyebilirsiniz.
