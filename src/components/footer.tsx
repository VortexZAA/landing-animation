  ...
  return (
    <>
      <footer
        className={` ${
          status ? "px-6" : "pr-6"
        } w-full h-16  absolute bottom-3 left-0 z-30  flex items-center justify-between   text-white text-sm font-normal`}
      >
        <div
          className={` ${
            status ? "" : "ml-[86px] xl:ml-[280px]"
          }  px-6 backdrop-blur-sm flex items-center justify-between bg-white/10 rounded-md h-full w-full`}
        >
