...
export default function Intro() {
  ...
  return (
    ...
    >
      <h1  id="h1" className={`text-2xl hidden md:block md:text-5xl w-full text-center `} > FACI Protocol</h1>
      <h1 className={`text-2xl md:text-5xl w-full text-center !visible block md:hidden `} >FACI Protocol</h1>
